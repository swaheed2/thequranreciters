...
<?php
  ...
  if ($user->logged_in)
      redirect_to("http://thequranreciters.com/pages/full-downloads.php");
...
<form method="post" id="login_form" name="login_form" class="xform" style="display:none">
