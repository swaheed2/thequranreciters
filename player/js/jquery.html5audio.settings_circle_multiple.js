...
var hap_group = 'circle', hap_player1, hap_player2, hap_players = [hap_player1, hap_player2], soundArr;
jQuery(document).ready(function($) {
	...
	soundArr = [{player_id: hap_players[0], sound_id: 'circle_multiple1'},
				{player_id: hap_players[1], sound_id: 'circle_multiple2'}];		
