...
/* useOnlyMp3Format: true/false (set to true, and on browsers than do not support mp3, flash will be used to play mp3. Also set to true if you plan on using podcast, soundcloud, youtube, ofm) */
	...
	buttonsUrl: {prev: 'media/data/icons/set4/prev.png', prevOn: 'media/data/icons/set4/prev_on.png', 
				 next: 'media/data/icons/set4/next.png', nextOn: 'media/data/icons/set4/next_on.png', 
				 pause: 'media/data/icons/set4/pause.png', pauseOn: 'media/data/icons/set4/pause_on.png',
				 play: 'media/data/icons/set4/play.png', playOn: 'media/data/icons/set4/play_on.png',
