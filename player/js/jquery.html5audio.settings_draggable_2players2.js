...
var hap_player1, hap_player2, hap_players = [hap_player1, hap_player2];
jQuery(document).ready(function($) {
	...
	//init component
	hap_players[0] = $('#componentWrapper').css('zIndex',100).html5audio(hap_settings);
